...
IMPACT_INPUT_RANGE =     {'sourceType':IMPACT,    'parameter':RANGE,   'name':"Range of source levels",'unit':"meters",   'value':10.0}
...
DTH_INPUT_RANGE =   {'sourceType':DTH,    'parameter':RANGE,   'name':"Range of source levels",    'unit':"meters",    'value':10.0}
...
VIBRATORY_INPUT_RANGE = {'sourceType':VIBRATORY,    'parameter':RANGE,   'name':"Range of source levels",    'unit':"meters",    'value':10.0}
